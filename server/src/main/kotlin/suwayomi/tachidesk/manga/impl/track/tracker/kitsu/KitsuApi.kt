...
import suwayomi.tachidesk.manga.impl.track.tracker.kitsu.dto.KitsuIncludedMedia
...
class KitsuApi(
    ...
    private fun KitsuIncludedMedia.toTrackRelated(relationType: String?): TrackRelated {
        val mangaId = this.id
        return TrackRelated(
